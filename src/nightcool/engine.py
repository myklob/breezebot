...
def _find_close_moment(
    ...
    # Floor first so it wins timestamp ties: `min` is stable, and when the
    # floor hit lands on the same forecast hour as a warmup, the floor
    # warning is the one worth surfacing.
